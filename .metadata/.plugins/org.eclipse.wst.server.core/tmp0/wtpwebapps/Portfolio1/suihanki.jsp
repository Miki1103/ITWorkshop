...
<body>   
    <header class="page-header">
     ...
     <form action="Suihanki" method="post">
     <p>Q1.お米は硬めが好き？</p>

    <input type="radio" name="q1" value="yes">はい<br>
    <input type="radio" name="q1" value="no">いいえ

    <p>Q2.銘柄によって炊き分けしたい？</p>

    <input type="radio" name="q2" value="yes">はい<br>
    <input type="radio" name="q2" value="no">いいえ

    <p>Q3.どちらを重要視する？</p>

    <input type="radio" name="q3" value="cost">本体価格の安さ<br>
    <input type="radio" name="q3" value="good">お米の美味しさ
